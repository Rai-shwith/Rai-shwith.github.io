    ...
    <div className="flex flex-col items-center my-8">
      ...
      <div className="grid md:grid-cols-3 w-full gap-5 justify-center mt-5">
        <Card
          ...
          tags={["Github API", "LeetCode API", "Websocket", "Full Stack"]}
          description={
        ...
        <Card
          ...
          tags={["LeetCode", "DSA", "Problem Solving", "Well Organized"]}
          description={
...
tags={["React", "Local Storage", "State Management", "Frontend", "To-Do App", "Data Persistence", "Web Application"]}
...
tags={["Shell Scripting", "Directory Management", "File Structure", "Command Line Tools", "Emmet Syntax", "Terminal Tools", "Efficiency", "Scripting", "Open Source"]}
...
tags={["Web Development", "Hybrid Learning", "College Program", "Daily Tasks", "Exercises", "Assignments", "Front-End", "Learning Path"]}
